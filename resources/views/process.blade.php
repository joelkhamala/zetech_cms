            ...
            <div class="col-md-5">
                <div class="process-box process-left" data-aos="fade-right" data-aos-duration="1000">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <h5>Department Clearance</h5>
                            <p>
                                <small>The HOD of your department must first Enter your details into the system and the Senate Approves </small>
                                <small>Afterwards, you have to confirm the name details by clicking on <span style="" class="font-weight-bold">Department->Confirm Name.</span> </small>
                            </p>
                        </div>
                    </div>
                ...
                <div class="process-box process-right" data-aos="fade-left" data-aos-duration="1000">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <p>
                                <small>The Librarian has to check if you have any  broowed books. You cannot be cleared if you owe the school any library material</small>
                            </p>
                            <p>
                                <small>You can check clearance status by clicking <span style="" class="font-weight-bold">Library->Clearance Status.</span> </small>
                            </p>
                        </div>
                    </div>
