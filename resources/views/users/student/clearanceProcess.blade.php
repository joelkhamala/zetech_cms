...
<div>
   ...
   <div class="platform-tour-wrapper py-4">
      ...
      <ul class="nav nav-tabs justify-content-between border-0 horizontal-tabs-steps">
        ...
        {{ $bookLock = ''}}
            @if($student->confirmed == 'confirmed' && $student->status_of_graduation == 'approved')
                {{ $next= ''}}
            @else
            {{ $next = '#' }}
            @endif
         ...
         <li class="nav-item">
            ...
            <h6 class="text-center mt-1"> Department</h6>
         </li>
         <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#step2{{$next}}"><span>2</span></a>
            <h6 class="text-center mt-1">Library </h6>
         </li>
         <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#step3{{$next}}{{$bookLock}}"><span>3</span></a>
            <h6 class="text-center mt-1">Finance</h6>
         </li>
         <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#step4{{$next}}{{$bookLock}}{{$finLock}}"><span>4</span></a>
            <h6 class="text-center mt-1">Gown</h6>
         </li>
         <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#step5{{$next}}{{$bookLock}}{{$finLock}}{{$certLock}}"><span>5</span></a>
            <h6 class="text-center mt-1">Certificate</h6>
         </li>
      </ul>
      <!-- Tab panes -->
      <div class="tab-content platform-content mt-2 mb-4">
         <div id="step1" class="tab-pane active p-0">
            <h3 class="mb-4">Department Clerance</h3>
            <!------vertical Tabs------------->
            <div class="row">
                                            ...
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table class="table table-stripped table-sm table-bordered">
                                                        <tr><td><span class="font-weight-bold">Book Title:</span></td><td>{{ $book->book_title }}</td></tr>
                                                        <tr><td><span class="font-weight-bold">Book Name:</span></td><td>{{ $book->book_name }}</td></tr>
                                                        <tr><td><span class="font-weight-bold">Book Author:</span></td><td>{{ $book->book_author }}</td></tr>
                                                        <tr><td><span class="font-weight-bold">Date Borrowed:</span></td><td>{{ $book->date_borrowed }}</td></tr>
                                                        <tr>
                                                            <td>
            ...
            <div class="row">
               <div class="col-lg-1 col-md-2 col-sm-2 col-3 vertical-tabs-steps pr-0">
                  <ul class="nav nav-tabs d-flex flex-sm-column border-0" id="myTab" role="tablist">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#step4_2" role="tab" aria-controls="profile"><span>Gown Return Status</span></a>
                     </li>
                  </ul>
               </div>
               <div class="col-lg-11 col-md-10 col-sm-10 col-9 p-0 pl-md-2">
                  <div class="tab-content vertical-tabs-content">
                     ...
                     <h3 style="font-size:1.2rem; margin:0 0 1.5rem">Gown Clearance</h3>
               ...
               <div class="col-lg-11 col-md-10 col-sm-10 col-9 p-0 pl-md-2">
                  <div class="tab-content vertical-tabs-content">
                     <div class="tab-pane active" id="step5_1" role="tabpanel">
                        <h3 style="font-size:1.2rem; margin:0 0 1.5rem">Lorem ipsum</h3>
