            ...
            <table class="table table-hover">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>{{ $transcript->file_name }}</td>
                     <td>
                        <form method="POST" action="{{ route('delTrans', $transcript->transcript_id)}}">
                        @csrf
                        <input type="hidden" name="email" value="{{$transcript->email}}">
                        <input type="hidden" name="transcript_serial_number" value="{{$transcript->transcript_serial_number}}">
                        <input type="hidden" name="file_name" value="{{$transcript->file_name}}">
                        <input type="hidden" name="department_id" value="{{$transcript->department_id}}">
                        <input type="hidden" name="program_id" value="{{$transcript->program_id}}">
                        <input type="hidden" name="trans_delete" value="{{$transcript->file_name}}">
