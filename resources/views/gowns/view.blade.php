                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('gowns.update', $gown->gown_id) }}">
                        ...
                        <div class="col-md-8 mb-3">
                            ...
                            <div class="">
                                <input id="gown_condition" type="text" class="form-control @error('gown_condition') is-invalid @enderror" name="gown_condition" value="{{ old('gown_condition', $gown->condition) }}" disabled autocomplete="gown_condition" autofocus>
